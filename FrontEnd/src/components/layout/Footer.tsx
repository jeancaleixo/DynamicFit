          ...
          <div className="mt-8 grid grid-cols-2 gap-8 lg:mt-0 lg:grid-cols-5 lg:gap-y-16">
            ...
            <div className="col-span-2 sm:col-span-1">
              ...
              <ul className="mt-6 space-y-4 text-sm">
                ...
                <li><span>R.NELSON PIZZOLITTO, 10.JD ORQUÍDEAS</span></li>

                <li><span>ESTR. DOS CASA, 4062.JD IPANEMA</span></li>
            ...
            <div className="col-span-2 sm:col-span-1">
              ...
              <ul className="mt-6 space-y-4 text-sm">
                <li>
                  <span>SEG-SEX das 06 às 22</span>
                </li>

                <li>
                  <span>SABADO das 09 às 14</span>
                </li>
            ...
            <div className="col-span-2 sm:col-span-1">
              ...
              <ul className="mt-6 space-y-4 text-sm">
                <li>
                  <span>CNPJ: 35.412.133/0001-50</span>
                </li>
              </ul>
            </div>
